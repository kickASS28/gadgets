  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.pagedesc}>
        ...
        <p>
          We provide best in class resources, latest realtime updates and great
          tools for day to day needs.
        </p>
      </div>
      ...
      <div className={classes.verticals}>
        <div className={classes.health}>
          ...
          <div className={classes.description}>
            <p>
              Track your calorie intake, Calulate BMI, tips from physicians and
              more..
            </p>
          </div>
        </div>
        <div className={classes.finance}>
          ...
          <div className={classes.description}>
            <p>
              Loan to intrest calculator, make your plan, latest market news,
              etc.
            </p>
          </div>
        </div>
